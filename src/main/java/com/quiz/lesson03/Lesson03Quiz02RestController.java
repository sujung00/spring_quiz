...
public class Lesson03Quiz02RestController {
	...
	@Autowired
	private RealEstateBO relEstateBO;
	...
	public String quiz02_1() {
		...
		int rowCount = relEstateBO.addRealEstate(realEstate);
	...
	public String quiz02_2(
		...
		int rowCount = relEstateBO.addRealEstateAsField(realtorId, "썅떼빌리버 오피스텔 814호", 45, "월세", 100000, 120);
